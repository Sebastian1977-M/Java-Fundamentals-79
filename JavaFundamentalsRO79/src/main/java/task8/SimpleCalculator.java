...
public class SimpleCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("Introduceti un operator matematic (+,-,*,/): ");

        char operator = scanner.next().charAt(0);//citim string care contine un singur caracter
        //facem conversia de la string la char
        ...
        switch (operator) {
            ...
            case '/':
                ...
                default:
                    ...
                    throw new InputMismatchException("Simbol it's not suported");
        }
